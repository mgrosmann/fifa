...
# --- fichiers ---
source_csv = "teamplayerlinks.csv"          # ton fichier FIFA 14
output_txt = "teamplayerlinks_fifa16_format.txt"   # sortie FIFA 15 compatible

# --- ordre exact des colonnes FIFA 15 ---
fifa15_order = """leaguegoals;isamongtopscorers;yellows;isamongtopscorersinteam;jerseynumber;position;artificialkey;teamid;leaguegoalsprevmatch;injury;leagueappearances;prevform;istopscorer;leaguegoalsprevthreematches;playerid;form;reds""".replace("\n", "").split(";")
