...
# --- fichiers ---
source_csv = "leagueteamlinks.csv"          # ton fichier FIFA 15
output_txt = "leagueteamlinks_fifa16_format.txt"   # sortie FIFA 16 compatible

# --- ordre exact des colonnes FIFA 16 ---
fifa16_order = """homega;previousyeartableposition;homegf;currenttableposition;awaygf;awayga;teamshortform;hasachievedobjective;secondarytable;yettowin;unbeatenallcomps;unbeatenleague;champion;leagueid;prevleagueid;highestpossible;teamform;highestprobable;homewins;artificialkey;nummatchesplayed;teamid;gapresult;grouping;awaywins;objective;points;actualvsexpectations;homelosses;unbeatenhome;lastgameresult;unbeatenaway;awaylosses;awaydraws;homedraws;teamlongform""".replace("\n", "").split(";")
